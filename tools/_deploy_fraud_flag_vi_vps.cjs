/**
 * Upload admin fraud-flag VI labels → VPS, rebuild FE, restart shop.
 */
const fs = require("fs");
...
const files = [
  "frontend/components/admin/ctv/shared/format.ts",
...
console.log("Deploying fraud flag VI labels →", connect.host);
const c = new Client();
c.on("ready", () => {
